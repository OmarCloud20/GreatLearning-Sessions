# How to Build a CI/CD Pipeline using AWS CodePipeline, AWS CodeBuild and CodeCommit to deploy Containerized Static Website image to AWS ECR and to Deploy it to AWS ECS - Fargate
